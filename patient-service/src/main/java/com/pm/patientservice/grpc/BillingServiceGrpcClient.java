...
public class BillingServiceGrpcClient {
    ...
    // Bildiğimiz gRPC client oluyor, senkron client nesnesini tanımlıyor:
    // Stub'ı kabaca uzaktaki servisin Java tarafındaki temsilcisi gibi düşünebiliriz
    // çağrı yapılana kadar thread bekler, thread süreçleriyle de alakalı
    ...
    public BillingServiceGrpcClient(
        ...
        // usePlaintext() encryption'ı kapatıyor dev ortamında daha rahat anlamak adına
